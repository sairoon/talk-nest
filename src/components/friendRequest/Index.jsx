    ...
    <>
      <div className="bg-transparent dark:bg-slate-600 shadow-lg rounded-[10px] py-5 px-6 h-full overflow-y-auto">
        ...
        <div className="flex items-center justify-between mt-6">
          ...
          <img src="https://picsum.photos/206" className="w-16 h-16 rounded-full" alt="user-img"/>
        ...
        <div className="flex items-center justify-between mt-6">
          <div className="flex items-center gap-3">
          <img src="https://picsum.photos/205" className="w-16 h-16 rounded-full" alt="user-img"/>
          <h3 className="text-2xl font-normal text-[#3D3C3C] dark:text-white">
              User Name
            </h3>
          </div>
        ...
        <div className="flex items-center justify-between mt-6">
          <div className="flex items-center gap-3">
          <img src="https://picsum.photos/201" className="w-16 h-16 rounded-full" alt="user-img"/>
          <h3 className="text-2xl font-normal text-[#3D3C3C] dark:text-white">
              User Name
            </h3>
          </div>
