    ...
    <>
      <div className="bg-transparent dark:bg-slate-600 shadow-lg rounded-[10px] py-5 h-full overflow-y-auto relative">
        <div className="px-6">
          ...
          <input
            type="search"
            className="my-6 rounded-[10px] py-3 px-4 w-full bg-[#F8F8F8] dark:bg-slate-700 outline-none text-2xl font-normal text-gray-600 dark:text-gray-300 placeholder:text-[#CBCBCB] dark:placeholder:text-slate-400 mb-5 caret-purple-500"
